                            ...
                            <div class="modal-content">
                                <form action="profile.php" method="post" enctype="multipart/form-data">
                                    <div class="modal-header">
                                        ...
                                        <button class="btn-close" type="button" data-bs-dismiss="modal" aria-ladel="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        ...
                                        <div class="mb-3">
                                            <label class="mb-3">プロフィール写真</label>
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button class="btn" type="subnit">保存する</button>
                                    </div>
                                </form>
                            </div>
                            </div>
